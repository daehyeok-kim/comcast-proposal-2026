...
The system will leverage request and response timing patterns, RTT measurements, and application-layer timing information to infer network latency and compute remaining time budgets.
...
\item Validation methodology using traces from multiple access network types to ensure estimation accuracy generalizes across deployment scenarios.
\end{packeditemize}
...
\item Support for sub-50 ms SLOs required by emerging applications such as interactive XR offloading, where jitter directly impacts user experience.
