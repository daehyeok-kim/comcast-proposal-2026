...
The proposed framework is designed to support both today's latency-sensitive services (\eg live video analytics and edge AI inference) and emerging applications with tighter constraints, such as interactive XR offloading and gaming.
...
The PI has proven track records of developing innovative solutions in networks and networked systems.
In particular, he is an expert in 5G cellular systems~\cite{mobicom23-atlas, sigcomm23-slingshot, sec-fronthaul}, real-time edge computing~\cite{infocom26-pendulum,arma:mobisys25,nsdi26-smec}, programmable networks~\cite{sigcomm21-redplane, nsdi23-exoplane, sigcomm20-tea, micro23-lognic, nsdi25-alkali}, and network telemetry~\cite{nsdi22-sketchlib, nsdi23-sketchovsky,sosr21-telemetry}.